...
set :application, "jannde"
set :repo_url, "https://github.com/thkernel/jannde_platform.git"
...
# Default value for :linked_files is []
 append :linked_files, "config/database.yml", "config/master.key", "config/storage.yml", ".env"
